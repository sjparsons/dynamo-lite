...
export class CreateTable
  extends $Command<CreateTableCommandInput>
  implements Command<CreateTableCommandInput, CreateTableCommandOutput>
{
  constructor(input: CreateTableCommandInput) {
    super(input);
  }
  resolveAsSQL(): SqlCommand {
    const tableName = validateTableName(this.input.TableName);
    return {
